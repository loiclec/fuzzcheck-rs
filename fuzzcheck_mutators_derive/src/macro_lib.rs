...
pub struct StructData {
    ...
    struct_fields: Option<TokenTree>, // Group
}
pub struct StructField {
    whole: TokenStream,
    attributes: Vec<TokenStream>,
    visibility: Option<TokenStream>,
    identifier: Option<TokenTree>, // Ident
    ty: TokenStream,
}
...
pub struct Generics {
    whole: TokenStream,
    params: Vec<(TokenTree, TypeParam)>,
}
