...
Generated by a procedural macro of [`fuzzcheck`]",
    ...
    "impl " NameMutator_generics cm.Default "for" NameMutator NameMutator_generics.removing_bounds_and_eq_type()
            ...
            for " NameMutator NameMutator_generics.removing_bounds_and_eq_type() NameMutator_where_clause "
        {
            ...
            #[doc(hidden)]
            #[no_coverage]
            fn all_paths(&self, value: &" type_ident type_generics.removing_bounds_and_eq_type() ", cache: &Self::Cache, register_path: &mut dyn FnMut(" cm.TypeId ", Self::LensPath)) {
                " InnerMutator_as_Mutator "::all_paths(&self.mutator, value, &cache.inner, #[no_coverage] &mut |typeid, subpath| {
