...
use syn::{parse_macro_input, Data, DataStruct, DeriveInput, Ident, Index, Visibility};
...
fn make_struct_mutator(name: Ident, visibility: Visibility, data: DataStruct) -> TokenStream {
